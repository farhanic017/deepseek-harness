 ...
 * "Choose workspace" call to action. When a workspace is selected, a small
 * detach button appears to remove it without opening the menu.
 * @param props.label - chip label (see {@link workspaceLabel}); omitted → placeholder.
 * @param props.menuOpen - menu expansion echo.
 * @param props.onClick - menu toggle.
 * @param props.onRemove - detach the selected workspace (shown only when label is set).
...
export function WorkspaceChip({ buttonRef, label, menuOpen = false, onClick, onRemove, t }: {
  ...
  return (
    <span className={css.workspaceWrap}>
      <button
        ref={buttonRef}
        type="button"
      ...
      {label !== undefined && onRemove !== undefined && (
        <button
          type="button"
