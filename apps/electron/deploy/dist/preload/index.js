...
function injectMenuBar() {
    if (document.getElementById('electron-menu-bar-injected'))
        return;
...
const electronAPI = {
    ...
    menu: {
        action: (action) => ipcRenderer.send('menu:action', action),
    },
